...
# --- CONFIGURAÇÕES OSC ---
OSC_IP = "127.0.0.1" # IP do computador rodando a Unreal. Mantenha 127.0.0.1 se for o mesmo PC.
OSC_PORT = 8000  # Porta que a Unreal estará escutando.
client = udp_client.SimpleUDPClient(OSC_IP, OSC_PORT)
client2 = udp_client.SimpleUDPClient("127.0.0.1", 8001)
