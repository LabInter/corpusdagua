...
while True:
    ...
    for i in np.arange(0, detections.shape[2]):
        ...
        if confidence > 0.5:
            ...
            if CLASSES[idx] == "person":
                ...
                print(f"/person/{person_count}/position", [normalizedX, normalizedY])
    ...
    # Exibe a contagem total de pessoas no quadro
    cv2.putText(frame, f"Pessoas Detectadas: {person_count}", (10, 30),
    ...
    if results.multi_hand_landmarks:
        ...
        for i in range(len(results.multi_hand_landmarks)):
            ...
            print(f"/hand/{hand_id}/position ({label})", [normalized_hand_x, normalized_hand_y])
